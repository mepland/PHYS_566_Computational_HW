...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.8\textwidth]{poisson_dipole/part_b/Niter_vs_epsilon.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.8\textwidth]{poisson_dipole/part_c/Niter_vs_n.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.8\textwidth]{poisson_dipole/extra_material/V_prop_illustration.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
