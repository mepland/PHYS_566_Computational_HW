...
The nuclear decay of Carbon-14, which must be well understood to facilitate the method of Carbon dating, was successfully modeled numerically via the Euler method, as well as being solved analytically in Section~\ref{sec:theory}. Of the three time steps used, the smaller two produced acceptable results within \le1\% of the exact result while the largest was unacceptable at 9.2\%. In all three cases the deviation from the exact result was much less than the second order term of the analytic solution.
