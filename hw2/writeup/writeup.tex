...
\begin{abstract}
Python code was written to compute 
...
\clearpage
\section{Code}
The source code to make these plots can be found online at \url{http://github.com/mepland/PHYS_566_Computational_HW/tree/master/hw2/code}, as well as in plain text below.
