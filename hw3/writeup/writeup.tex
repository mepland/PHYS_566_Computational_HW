...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.70\textwidth]{dimpled_ball_w_drag_and_spin.png}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
% TODO Temporarily force a new page
\clearpage
...
\lstinputlisting[style=output,label={lst:output}]{../code/output.log} % TODO raw
