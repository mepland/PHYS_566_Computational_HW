...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_b/compare_runs_vary_sim_method/theta_vary_sim_method.pdf}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_b/compare_runs_vary_sim_method/omega_vary_sim_method.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_c/energy/energy_Euler-Cromer.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_c/energy/energy_RK4.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_b/res_sweep_rk4_linear/res_sweep_thetaP.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_b/res_sweep_rk4_linear/res_sweep_phi.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_b/res_sweep_rk4_linear/res_runs/res_run_omegaD_over_omega_res_theory_1.78}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_b/res_sweep_rk4_linear/res_runs/res_run_omegaD_over_omega_res_theory_1.78_fit_region}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/compare_runs_vary_linearity_low_alphaD/theta_vary_linearity_low_alphaD.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/compare_runs_vary_linearity_low_alphaD/omega_vary_linearity_low_alphaD.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/compare_runs_vary_linearity_high_alphaD/theta_vary_linearity_high_alphaD.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/compare_runs_vary_linearity_high_alphaD/omega_vary_linearity_high_alphaD.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_d/res_sweep_rk4_nonlinear/res_runs/res_run_omegaD_over_omega_res_theory_0.48_fit_region}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_d/res_sweep_rk4_nonlinear/res_runs/res_run_omegaD_over_omega_res_theory_1.33_fit_region}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/res_sweep_rk4_nonlinear/res_sweep_thetaP.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{part_d/res_sweep_rk4_nonlinear/res_sweep_phi.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_0.2_theta0_0.000_rk4/runs/alphaD_0.2_theta0_0.000_Delta_theta0_0.002000_rk4}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
	\caption{$\big|\Delta\theta\left(t\right)\big|$ curve and linear fit, $\alpha_{D} = 0.2$ [rad/s$^2$], non-chaotic regime.}
	\label{fig:Dtheta_0.2}
\end{figure}

\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_0.2_theta0_0.000_rk4/ave_of_alphaD_0.2_theta0_0.000_rk4_means_plot}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_0.5_theta0_0.000_rk4/runs/alphaD_0.5_theta0_0.000_Delta_theta0_0.002000_rk4}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
	\caption{$\big|\Delta\theta\left(t\right)\big|$ curve and linear fit, $\alpha_{D} = 0.5$ [rad/s$^2$], TODO regime.}
	\label{fig:Dtheta_0.5}
\end{figure}

\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_0.5_theta0_0.000_rk4/ave_of_alphaD_0.5_theta0_0.000_rk4_means_plot}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
	\caption{$\lambda_{\text{Fit}}$ curve and mean, $\alpha_{D} = 0.5$ [rad/s$^2$], TODO regime.}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_1.2_theta0_0.000_rk4/runs/alphaD_1.2_theta0_0.000_Delta_theta0_0.002000_rk4}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
...
\begin{figure}[!htbc]
  \centering
  \includegraphics[width=.65\textwidth]{{part_e/lyapunov_ave/ave_of_alphaD_1.2_theta0_0.000_rk4/ave_of_alphaD_1.2_theta0_0.000_rk4_means_plot}.pdf}
	{\par\nobreak\rule[9pt]{35em}{0.5pt}\vspace{-5mm}}
